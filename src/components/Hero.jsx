...
const Hero = () => {
  return (
    <div
      ...
      <img className='absolute object-cover top-0 w-full max-sm:h-120 md:h-150 -z-2' src={assets.header_img} alt="" />

      <motion.p
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
        className='text-7xl w-4/5 max-sm:leading-14 sm:leading-19 text-center font-extrabold mb-10 max-sm:text-5xl max-sm:w-full max-sm:font-bold'>Explore homes that fit your dreams</motion.p>
