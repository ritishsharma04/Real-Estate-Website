...
const Projects = () => {
  return (
    <div id='projects' className='max-w-[1440px] mx-auto flex flex-col items-center max-sm:px-8 max-sm:pt-6 md:pt-15 xl:pt-25 sm:px-12 lg:px-24 xl:px-40'>
            ...
            className=' flex max-sm:flex-wrap items-center gap-4 pt-4 max-sm:gap-2 sm:pt-15'>
                ...
                {projectsData.map((data, index)=> (
                    <div className='w-full flex flex-col items-center' key={index}>
                        ...
                        <div className='relative -top-10 bg-white  px-4 py-2 shadow'>
